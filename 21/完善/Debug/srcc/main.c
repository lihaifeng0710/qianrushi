...
//     while(1){}
    ...
    for(;;)   //for(;;)（开头）
    {
        ...
        if (gpio_get(RAY_HUMAN))
        {
            ...
            printf("红外：监测有人\r\n\r\n");
            LCD_DrawCircle(180,262,10,BLACK);
            LCD_DrawLine(180,272,180,290,BLACK);
            LCD_DrawLine(180,280,190,297,BLACK);
            LCD_DrawLine(180,280,170,297,BLACK);
            LCD_DrawLine(180,290,190,310,BLACK);
            LCD_DrawLine(180,290,170,310,BLACK);
        }
        else
        {
...
//        printf(" bat_V：%4.1lf V--\n",bat_V);
        ...
        // TM1637_Display(a,0,b,1,c,0,d,0); 
...
{	
    ...
    {
    	case 1:
    		TM1637_Display(1,0,1,1,1,0,1,0); 
    		printf("数码管显示1111\r\n\r\n");
            break;
        case 2:
    		TM1637_Display(2,1,2,1,2,1,2,1);
    		printf("数码管显示2222\r\n\r\n");
            break;
        case 3:
            TM1637_Display(3,1,3,1,3,1,3,1);
            printf("数码管显示3333\r\n\r\n");
            break;
        default:
	        break;
