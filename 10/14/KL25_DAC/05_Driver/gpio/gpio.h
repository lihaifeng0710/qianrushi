...
//      PTE:0-5、20~25、29~31
//   (2)关于GPIO类中断
//      PTA、PTD口引脚具有GPIO类中断功能，分别是46、47号中断向量。
...
//引脚中断类型宏定义
#define LowLevel        8    //低电平触发
#define HighLevel       12   //高电平触发
#define RisingEdge      9    //上升沿触发
#define FallingEdge     10   //下降沿触发
#define DoubleEdge      11   //双边沿触发
