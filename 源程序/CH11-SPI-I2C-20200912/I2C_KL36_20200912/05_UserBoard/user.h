...
//I2C模块定义
#define I2C_SEND     0  //SDA引脚：GEC_46（PTB_NUM|3）；SCL引脚： GEC_47（PTB_NUM|2）
#define I2C_RECEIVE  1  //SDA引脚：GEC_38（PTC_NUM|2）；SCL引脚： GEC_39（PTC_NUM|1）
#define I2C_SEND_Handler    	I2C0_IRQHandler  //I2C0中断函数
#define I2C_RECEIVE_Handler     I2C1_IRQHandler  //I2C1中断函数
