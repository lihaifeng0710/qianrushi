...
//函数返回：无
//参数说明：无
//功能概要：设置用户可用中断的ISR，所设置ISR执行代码见isr.c中定义
//======================================================================
void Int_Handler_init();

//本例程定义的中断服务例程----------------------------------------------------
void  __attribute__((weak)) GPIOA_Handler(void);   //GPIOA中断
void  __attribute__((weak)) GPIOB_Handler(void);   //GPIOB中断
void  __attribute__((weak)) UARTA_Handler(void);   //UART0接收中断
void  __attribute__((weak)) I2CA_Handler(void);    //I2C0接收中断
void  __attribute__((weak)) I2CB_Handler(void);    //I2C1接收中断
void  __attribute__((weak)) SPIA_Handler(void);    //SPI0接收中断
void  __attribute__((weak)) SPIB_Handler(void);    //SPI1接收中断
void  __attribute__((weak)) INCAP_Handler(void);   //TPM0定时器
void  __attribute__((weak)) TIMERA_Handler(void);  //LPTMR0
void  __attribute__((weak)) TIMERB_Handler(void);  //TPM1定时器
void  __attribute__((weak)) TSI_Handler(void);     //TSI触摸中断
//----------------------------------------------------------------------
...
//（2）UART引脚
//UART模块定义
#define UARTA  0  //TX引脚： GEC_10；RX引脚： GEC_8
...
//（11）DMA通道定义
#define DMA_CH0  0  //通道0  对应UARTA
#define DMA_CH1  1  //通道1  对应UARTA
#define DMA_CH2  2  //通道2  对应UARTA
#define DMA_CH3  3  //通道3  对应UARTA
